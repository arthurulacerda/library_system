...
class RentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post rents_url, params: { rent: { bill_day_delay: @rent.bill_day_delay, book_id: @rent.book_id, days_to_deadline: @rent.days_to_deadline, user_id: @rent.user_id } }
    end
  ...
  test "should update rent" do
    patch rent_url(@rent), params: { rent: { bill_day_delay: @rent.bill_day_delay, book_id: @rent.book_id, days_to_deadline: @rent.days_to_deadline, user_id: @rent.user_id } }
